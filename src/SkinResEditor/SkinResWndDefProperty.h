...
public:
        ...
        SkinWndPropertyList& WndProperty)
    {
        ...
        GetResWndProperty(WndProperty, pszPropertyDef, strClassName);
    }
...
private:
    ...
    static void GetResWndProperty( SkinWndPropertyList& WndProperty , LPCTSTR pszPropertyDef, KSGUI::CString strClassName)
    {
        WndPropertyEntryItem* pItemList = NULL;
        ...
        for ( int i = 0; i < nPropertyCount; i++ )
        {
            ...
            if ( !strClassName.CompareNoCase( skinxmlclrbtn::GetSkinWndClassName() ) &&
                 !item.strProperty.CompareNoCase( _T("BkColor") ) )
            {
                 item.strValue = _T("0x00808080");
            }
    ...
    static int GetWndPropertyEntry( WndPropertyEntryItem*& pItemList )
    {
        ...
        /* X*/ { _T("LinkFont")     , _T("ËÎÌו,GB2312_CHARSET,-12,0,400,0,0"), SkinPropertyView::it_font },

        /* Y*/ { _T("HotTextColor") , _T("0x00000000") , SkinPropertyView::it_color},
        /* Z*/ { _T("HotTextFont")  , _T("ËÎÌו,GB2312_CHARSET,-12,0,800,0,0"), SkinPropertyView::it_font },

        /* a*/ { _T("HotColor")     , _T("0x004080ff") , SkinPropertyView::it_color},
        /* b*/ { _T("FocusColor")   , _T("0x00c0c0c0") , SkinPropertyView::it_color},

        /* c*/ { _T("LineColor")    , _T("0x00c0c0c0") , SkinPropertyView::it_color},
    ...
    static int GetWndClassDefInfoEntry( WndClassDefInfo*& pItemList )
    {
        ...
        static WndClassDefInfo WndClassDefInfoyList[] = 
        {
            ...
            { skinxmlradiobox::GetSkinWndClassName()     , _T("ABCDEFGHIJ"), WS_CHILD | WS_VISIBLE | BS_AUTORADIOBUTTON | WS_TABSTOP, 0 },
            ...
            { skinxmlhscrollbar::GetSkinWndClassName()   , _T("ABCDEFGHIJ"), WS_CHILD | WS_VISIBLE | SBS_HORZ , 0 },
            { skinxmlvscrollbar::GetSkinWndClassName()   , _T("ABCDEFGHIJ"), WS_CHILD | WS_VISIBLE | SBS_VERT , 0 },
            ...
            { skinxmlstaticex::GetSkinWndClassName()     , _T("ABCDEFGHIJKcLMNO"), WS_CHILD | WS_VISIBLE | WS_TABSTOP, 0 },
            { skinxmlbmpbtn::GetSkinWndClassName()       , _T("ABCDEFGHIJPQ"), WS_CHILD | WS_VISIBLE | WS_TABSTOP, 0 },
            { skinxmlclrbtn::GetSkinWndClassName()       , _T("ABCDEFGHIJKLab"), WS_CHILD | WS_VISIBLE | WS_TABSTOP | BS_PUSHBUTTON, 0 },
                
            { skinxmlhtmlctrl::GetSkinWndClassName()     , _T("ABCDEFGHIJ"), WS_CHILD | WS_VISIBLE, 0 },
