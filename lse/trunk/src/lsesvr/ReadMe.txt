========================================================================
    ACTIVE TEMPLATE LIBRARY : lsesvr Project Overview
========================================================================

AppWizard has created this lsesvr project for you to use as the starting point for
...
lsesvr.idl
    ...
    This file will be processed by the MIDL compiler to generate:
        C++ interface definitions and GUID declarations (lsesvr.h)
        GUID definitions                                (lsesvr_i.c)
        A type library                                  (lsesvr.tlb)
        Marshaling code                                 (lsesvr_p.c and dlldata.c)

lsesvr.h
    This file contains the C++ interface definitions and GUID declarations of the
    items defined in lsesvr.idl. It will be regenerated by MIDL during compilation.
...
StdAfx.h, StdAfx.cpp
    ...
    named lsesvr.pch and a precompiled types file named StdAfx.obj.
...
lsesvrps.vcproj
	...
	dlldata.c, lsesvr_i.c and lsesvr_p.c which are required
