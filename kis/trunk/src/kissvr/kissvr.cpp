// kissvr.cpp : Implementation of WinMain
...
class CkissvrModule : public CAtlServiceModuleT< CkissvrModule, IDS_SERVICENAME >
{
public :
	DECLARE_LIBID(LIBID_kissvrLib)
	DECLARE_REGISTRY_APPID_RESOURCEID(IDR_KISSVR, "{47212797-3ACF-4DFF-92BF-50E6E702DA57}")
    ...
    BOOL Install() throw()
    {
        ...
        LoadString(_AtlBaseModule.GetModuleInstance(), 
            IDS_SERVICEDISPLAYNAME, szSvrDisName, sizeof(szSvrDisName) / sizeof(TCHAR));
        LoadString(_AtlBaseModule.GetModuleInstance(), 
