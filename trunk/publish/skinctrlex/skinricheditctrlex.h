...
class CSkinRichEditCtrlEx : 
    public KSGUI::SkinWindowImpl<CSkinRichEditCtrlEx, KSGUI::CSkinRichEditCtrl>
{

public:
    
    CSkinRichEditCtrlEx( HWND hNotifyWnd = NULL ) : 
    ...
    ~CSkinRichEditCtrlEx(void)
    {
    }

    BEGIN_MSG_MAP(CSkinRichEditCtrlEx)
    ...
    {
        BOOL bResult = KSGUI::SkinWindowImpl<CSkinRichEditCtrlEx, KSGUI::CSkinRichEditCtrl>::SubclassWindow(hWnd);
        if (!bResult)
            return bResult;
