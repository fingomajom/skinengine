...
#include <vector>
#include <map>
#include "skinapp.h"					//Í³Ò»×ÊÔ´Load

#define CPPString	WTL::CString
...
#pragma pack(1)
	typedef struct _STRUCT_IMAGE
	{
		...
		CPPString	strSkinRes;		//ksguiÖÐµÄÍ¼ÏóÃû³Æ				//±ù·å
...
#undef CHAR_FUDGE
	...
	void _AnalyseImageParam(CPPString & sProperties, _STRUCT_IMAGE & si)
	{
		...
		while (i < sProperties.GetLength())
		{
			...
			else if (sParameter == _T("skinres"))						//ksguiÖÐ×ÊÔ´Ãû³Æ
			{
