...
public:
	...
	{
        if ( m_wndUrlBar.IsDialogMessage(pMsg) )
            return TRUE;
...
//	LRESULT NotifyHandler(int /*idCtrl*/, LPNMHDR /*pnmh*/, BOOL& /*bHandled*/)
	...
	LRESULT OnCreate(UINT /*uMsg*/, WPARAM /*wParam*/, LPARAM /*lParam*/, BOOL& /*bHandled*/)
	{
        ...
        m_wndUrlBar.Create(m_hWnd);
        AddSimpleReBarBand(m_wndUrlBar);
    ...
    {
        TCHAR szURL[2048];
        m_wndUrlBar.GetDlgItemText(IDC_URL_EDIT, szURL, 2047);

        CComPtr<IWebBrowser2> spWebBrowser;

        m_view.QueryControl(&spWebBrowser);

        spWebBrowser->Navigate( szURL, 0, 0, 0, 0 );
