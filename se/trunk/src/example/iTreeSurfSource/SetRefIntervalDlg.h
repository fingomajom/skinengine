#if !defined( _ITREESURF__SETREFINTERVALDLG_H__INCLUDED_ )
#define _ITREESURF__SETREFINTERVALDLG_H__INCLUDED_
...
#endif // !defined( _ITREESURF__SETREFINTERVALDLG_H__INCLUDED_ )
