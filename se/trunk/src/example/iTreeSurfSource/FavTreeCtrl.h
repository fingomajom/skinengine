#if !defined( _ITREESURF__FAVTREECTRL_H__INCLUDED_ )
#define _ITREESURF__FAVTREECTRL_H__INCLUDED_
...
protected:
	...
	afx_msg void OnRfavMostFav();
	afx_msg void OnRfavfolderOpenmostfavorites();
	afx_msg void OnRfavAddshortcut();
	afx_msg void OnRfavAlias();
	afx_msg void OnRfavMostFolder();
...
#endif // !defined( _ITREESURF__FAVTREECTRL_H__INCLUDED_ )
