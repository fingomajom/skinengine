#if !defined( _ITREESURF__SETPROXY_H__INCLUDED_ )
#define _ITREESURF__SETPROXY_H__INCLUDED_
...
//	CStringList m_astrTempProxyPwd;
//	CStringList m_astrTempProxyUser;
//	CList<BYTE, BYTE> m_aTempProxySpeed, m_aTempWebProxySpeed;
...
protected:
	...
	afx_msg void OnRclickProxyList(NMHDR* pNMHDR, LRESULT* pResult);
	...
	//}}AFX_MSG
	afx_msg void OnSetSpeed(UINT nID); 
	DECLARE_MESSAGE_MAP()
private:
...
#endif // !defined( _ITREESURF__SETPROXY_H__INCLUDED_ )
