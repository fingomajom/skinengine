...
CAddressBarEx::CAddressBarEx()
{
	...
	//2002-07-12
	bool bResult=true;
	theApp._configFile.GetBool_ShowGoButton( bResult );
                           ...
                           DROPEFFECT dropEffect, CPoint point)
{
	...
	if( theApp._configFile._bUse3721 && use3721)
	{
		//use 3721
...
//3.6.1 add
int CAddressBarEx::OnCreate(LPCREATESTRUCT lpCreateStruct) 
{
