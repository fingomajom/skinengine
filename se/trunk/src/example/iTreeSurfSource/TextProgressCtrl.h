#if !defined( _ITREESURF__TEXTPROGRESSCTRL_H__INCLUDED_ )
#define _ITREESURF__TEXTPROGRESSCTRL_H__INCLUDED_
...
#endif // !defined( _ITREESURF__TEXTPROGRESSCTRL_H__INCLUDED_ )
