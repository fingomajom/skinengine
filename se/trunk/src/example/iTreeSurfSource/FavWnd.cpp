...
void CFavWnd::OnFavoritesOrgnizefavorites() 
{
	// TODO: Add your command handler code here
	 ( theApp._globalSpace._pMainFrame )->SendMessage(WM_COMMAND, ID_FAVORITES_ORGNIZEFAVORITES, 0);
}

void CFavWnd::OnFavoritesAddtofavorites() 
{
	// TODO: Add your command handler code here
	 ( theApp._globalSpace._pMainFrame )->SendMessage(WM_COMMAND, ID_FAVORITES_ADDTOFAVORITES, 0);
}
...
void CFavWnd::OnFavoritesBest() 
{
	...
	theApp._configFile._bMostFavChecked = m_bBest;

	 ( theApp._globalSpace._pMainFrame )->m_pwndExpObj->Update(1);
