...
#if !defined( _ITREESURF__StatusBarWithProgress_Hpp__INCLUDED_ )
#define _ITREESURF__StatusBarWithProgress_Hpp__INCLUDED_
...
#endif // !defined( _ITREESURF__StatusBarWithProgress_Hpp__INCLUDED_ )
