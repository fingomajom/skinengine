#if !defined( _ITREESURF__CHEVBAR_H__INCLUDED_ )
#define _ITREESURF__CHEVBAR_H__INCLUDED_
...
class CReBarCtrl;
class CChevBar : public CReBar//CControlBar//3.6.1
{
...
#endif // !defined( _ITREESURF__CHEVBAR_H__INCLUDED_ )
