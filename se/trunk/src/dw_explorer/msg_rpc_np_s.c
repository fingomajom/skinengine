...
/* Standard interface: msg_rpc_np, ver. 1.0,
   GUID={0xBF96E8AC,0x0903,0x44ad,{0xA8,0x48,0x5D,0xC1,0xB8,0x88,0x7F,0x1A}} */


extern const MIDL_SERVER_INFO msg_rpc_np_ServerInfo;

extern RPC_DISPATCH_TABLE msg_rpc_np_v1_0_DispatchTable;

static const RPC_SERVER_INTERFACE msg_rpc_np___RpcServerInterface =
    {
    sizeof(RPC_SERVER_INTERFACE),
    {{0xBF96E8AC,0x0903,0x44ad,{0xA8,0x48,0x5D,0xC1,0xB8,0x88,0x7F,0x1A}},{1,0}},
    {{0x8A885D04,0x1CEB,0x11C9,{0x9F,0xE8,0x08,0x00,0x2B,0x10,0x48,0x60}},{2,0}},
    &msg_rpc_np_v1_0_DispatchTable,
    0,
    0,
    0,
    &msg_rpc_np_ServerInfo,
    0x04000000
    };
RPC_IF_HANDLE msg_rpc_np_v1_0_s_ifspec = (RPC_IF_HANDLE)& msg_rpc_np___RpcServerInterface;

extern const MIDL_STUB_DESC msg_rpc_np_StubDesc;
...
/* 40 */	NdrFcShort( 0x400 ),	/* Type Offset=1024 */
...
static const unsigned short msg_rpc_np_FormatStringOffsetTable[] =
    {
    0
    };


static const MIDL_STUB_DESC msg_rpc_np_StubDesc = 
    {
    (void *)& msg_rpc_np___RpcServerInterface,
    MIDL_user_allocate,
    MIDL_user_free,
    0,
    0,
...
static RPC_DISPATCH_FUNCTION msg_rpc_np_table[] =
    {
    NdrServerCall2,
    0
    };
RPC_DISPATCH_TABLE msg_rpc_np_v1_0_DispatchTable = 
    {
    1,
    msg_rpc_np_table
    };

static const SERVER_ROUTINE msg_rpc_np_ServerRoutineTable[] = 
    {
    (SERVER_ROUTINE)ReceiveRpcMsg
    };

static const MIDL_SERVER_INFO msg_rpc_np_ServerInfo = 
    {
    &msg_rpc_np_StubDesc,
    msg_rpc_np_ServerRoutineTable,
    __MIDL_ProcFormatString.Format,
    msg_rpc_np_FormatStringOffsetTable,
    0,
    0,
    0,
    0};
