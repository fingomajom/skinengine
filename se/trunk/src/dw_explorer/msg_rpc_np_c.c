...
handle_t hMsgRpcNpBinding;


static const RPC_CLIENT_INTERFACE msg_rpc_np___RpcClientInterface =
    {
...
RPC_IF_HANDLE msg_rpc_np_v1_0_c_ifspec = (RPC_IF_HANDLE)& msg_rpc_np___RpcClientInterface;

extern const MIDL_STUB_DESC msg_rpc_np_StubDesc;

static RPC_BINDING_HANDLE msg_rpc_np__MIDL_AutoBindHandle;
    ...
    /* [out] */ VARIANT *ppOutBuf)
{
    ...
    _RetVal = NdrClientCall2(
                  ( PMIDL_STUB_DESC  )&msg_rpc_np_StubDesc,
...
static const MIDL_STUB_DESC msg_rpc_np_StubDesc = 
    {
    (void *)& msg_rpc_np___RpcClientInterface,
    MIDL_user_allocate,
    MIDL_user_free,
    &hMsgRpcNpBinding,
    0,
